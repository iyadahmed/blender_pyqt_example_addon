...
copytree(PARENT_DIR / "blender_pyqt6_example_addon", OUT_DIR / "package" / "blender_pyqt6_example_addon")
...
sp.run(["pip",
        ...
        "-t",
        OUT_DIR / "package" / "blender_pyqt6_example_addon" / "extern"])

# Create addon ZIP
zip_filename = f"blender-pyqt6-example-addon-Python-{python_version()}-{platform()}"
